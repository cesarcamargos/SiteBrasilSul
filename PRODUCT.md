...
Profissionais de TI e gestores de infraestrutura em empresas brasileiras que precisam licenciar e implantar software corporativo (Microsoft, Adobe, VMware, Veeam, segurança) e contratar IA corporativa via Azure. Chegam ao site avaliando fornecedores, comparando propostas e buscando confiança técnica antes de pedir uma cotação.
...
A identidade visual oficial está documentada em DesignSystemsBrasilSul.md: Segoe UI com fallback de sistema, base clara, azul de ação, superfícies brancas e hierarquia objetiva. Evitar excesso de elementos decorativos, glassmorphism e badges "AI-powered" piscando.
...
Sem requisito formal declarado no momento; seguir boas práticas gerais de acessibilidade (contraste adequado, navegação por teclado, textos alternativos) como padrão de qualidade, sem meta WCAG específica.
